...
describe('isKernelCommand', () => {
  it.each`
    ...
    ${{ method: KernelCommandMethod.InitKernel, params: null }} | ${true}        | ${'valid command with null data'}
...
describe('isKernelCommandReply', () => {
  it.each`
    value                                                                                     | expectedResult | description
    ${{ method: KernelCommandMethod.InitKernel, params: { initTime: 22, defaultVat: 'v0' } }} | ${true}        | ${'valid command with object data'}
